// ============================================================
//  INPUT PORTAL v2.0.1 — Apps Script Backend
//  Built on v8.0 baseline — SVMKPI_CORE.gs compatible
//  v2.0.1: Removed standalone onOpen(). Menu now owned by
//          SVMKPI_ADMIN.gs via addInputPortalMenu_() helper.
// ============================================================
...
function showSidebar() {
  try {
    var html = HtmlService.createHtmlOutputFromFile('Sidebar')
      .setTitle('Input Portal v2.0.1')
      .setWidth(300);
    SpreadsheetApp.getUi().showSidebar(html);
  } catch (e) {
    logError('showSidebar', e);
    throw e;
  }
}
...
// ============================================================
//  addInputPortalMenu_(menu)
//  Menu helper — called by SVMKPI_ADMIN.gs onOpen() to append
//  the Input Portal item to the master STORE VISIT KPI menu.
//
//  Do NOT add a standalone onOpen() here.
//  Single master onOpen() architecture — SVMKPI_ADMIN.gs owns it.
//
//  @param {GoogleAppsScript.Base.Menu} menu  The menu object
//         returned by SpreadsheetApp.getUi().createMenu(...)
//         before .addToUi() has been called.
// ============================================================
function addInputPortalMenu_(menu) {
  menu
    .addSeparator()
    .addItem('Open Input Portal', 'showSidebar');
}