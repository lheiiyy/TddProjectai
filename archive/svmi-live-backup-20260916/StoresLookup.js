...
//   3. Store List Provider
//   4. Store Lookup Engine
//   5. Insight Generator
// ------------------------------------------------------------
...
// ── Approved purposes (must match SVMKPI_CORE APPROVED_PURPOSES) ──
const SL_PURPOSES = [
  'STORE VISIT',
  'TLTC',
  'FAILED QA/MS',
...
// ═══════════════════════════════════════════════════════════════
// SECTION 2: SIDEBAR ENTRY POINTS
// ═══════════════════════════════════════════════════════════════

/**
 * openStoreLookupSidebar()
 * Opens the Store Intelligence window as a modeless dialog.
 * Upgraded from sidebar (380px) to full window (950×680px) for
 * executive presentation. Function name kept for ADMIN.gs compatibility.
 */
function openStoreLookupSidebar() {
  const html = HtmlService
    .createHtmlOutputFromFile('StoreLookup')
    .setWidth(950)
    .setHeight(680);
  SpreadsheetApp.getUi().showModelessDialog(html, 'Store Intelligence — SVMI');
}


// ═══════════════════════════════════════════════════════════════
// SECTION 3: STORE LIST PROVIDER
// ═══════════════════════════════════════════════════════════════
...
function _sl_emptyResult(storeName) {
  ...
  return {
    ...
    purposes:     SL_PURPOSES.map(label => ({ label, count: 0, pct: '0.0' })),
    topVisitors:  [],
    recentVisits: [],
    health,
...
// ═══════════════════════════════════════════════════════════════
// SECTION 6: BRAND LIST + MONTHLY COVERAGE (new — v1.1)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// SECTION 7: COMPLIANCE GAPS (Visits This Month tab)
// ═══════════════════════════════════════════════════════════════
