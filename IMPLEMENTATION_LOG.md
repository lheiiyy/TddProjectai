...
**The application itself has not changed since Phase 1G.** The five
rows above (Audit onward) and the Documentation track below are all
documentation/audit/architecture-only work — no `.gs`/`.html` file was
